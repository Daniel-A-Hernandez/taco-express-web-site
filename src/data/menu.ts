...
export const menu: Producto[] = [
  ...
  { id: "b-norm",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/Burrito.png', nombre: "Burrito Normal (20cm)",descripcion:'Relleno generoso de carne y acompañamientos, enrollado en tortilla de harina.', categoria: "BURRITOS", precioBase: 3.95, proteinas: CARNES_ESTANDAR, tipoExtra: 'global' },
  { id: "b-xl",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/Burrito_grande.png' ,nombre: "Burrito XL (25cm)",descripcion:'Versión grande, con más carne y relleno para mayor satisfacción.', categoria: "BURRITOS", precioBase: 4.95, proteinas: CARNES_ESTANDAR, tipoExtra: 'global' },
  { id: "b-mega",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/mega_burrito.png', nombre: "Mega Burrito (30cm)",descripcion:'Burrito extra grande, ideal para los más hambrientos.', categoria: "BURRITOS", precioBase: 6.50, proteinas: CARNES_ESTANDAR, tipoExtra: 'global' },

  // CATEGORÍA: ESPECIALIDADES (Extras Globales donde aplique)
  { id: "g-ord",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/Gringas.png', nombre: "Gringas (Orden de 3)",descripcion:'Tortilla de trigo rellena con carne a elección y quesillo especial fundido. Servidas con chirmol, pasta de aguacate y cebolla curtida.', categoria: "GRINGAS", precioBase: 3.75, proteinas: CARNES_TORTAS, tipoExtra: 'global' },
  ...
  { id: "s-tort",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/sopa%20de%20tortilla.png',  nombre: "Sopa de Tortilla",descripcion:'Caldo tradicional mexicano con trozos de pollo, tiras de tortilla frita, crema, aguacate, quesillo especial, cilantro y cebolla.', categoria: "SOPAS", precioBase: 4.50, tipoExtra: 'ninguno' },

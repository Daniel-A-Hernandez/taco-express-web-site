...
export const menu: Producto[] = [
  ...
  { id: "tr-mex",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/Torta_mexicana.webp' ,nombre: "Torta Mexicana",descripcion:'Pan relleno con carne de tu eleccion a la plancha, frijol molido, quesillo especial, pasta de aguacate, lechuga y chirmol.', categoria: "TORTAS", precioBase: 3.75, proteinas: CARNES_TORTAS, tipoExtra: 'costra'}, 
  ...
  { id: "tr-veg",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/torta-vegetariana.webp', nombre: "Torta Vegetariana",descripcion:'Frijol molido, pasta de aguacate, lechuga, tomate, chirmol, piña, chiles verdes y rojos, cebolla salteada y quesillo especial dentro de pan artesanal.', categoria: "TORTAS", precioBase: 3.50, tipoExtra: 'ninguno' },

  // CATEGORÍA: BURRITOS (Extras Globales)
  { id: "b-norm",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/Burrito.webp', nombre: "Burrito Normal (20cm)",descripcion:'Relleno generoso de carne y acompañamientos, enrollado en tortilla de harina.', categoria: "BURRITOS", precioBase: 3.95, proteinas: CARNES_ESTANDAR, tipoExtra:'burritos' },
  { id: "b-xl",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/Burrito_grande.webp' ,nombre: "Burrito XL (25cm)",descripcion:'Versión grande, con más carne y relleno para mayor satisfacción.', categoria: "BURRITOS", precioBase: 4.95, proteinas: CARNES_ESTANDAR, tipoExtra: 'burritos' },
  ...
  { id: "q-ord",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/quesadillas.webp', nombre: "Quesadillas (Orden de 3)",descripcion:'Tortilla de trigo rellena de quesillo especial y frijoles molidos. Acompañadas de chirmol, pasta de aguacate y cebolla curtida.', categoria: "QUESADILLAS", precioBase: 2.95, tipoExtra: 'ninguno' },
  { id: "s-tort",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/sopa%20de%20tortilla.webp',  nombre: "Sopa de Tortilla",descripcion:'Caldo tradicional mexicano con trozos de pollo, tiras de tortilla frita, crema, aguacate, quesillo especial, cilantro y cebolla.', categoria: "SOPAS", precioBase: 4.50, tipoExtra: 'sopas' },

  // CATEGORÍA: TAQUIZAS
  { id: "taq-10",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/taquiza-10.webp',  nombre: "Taquiza 10 Tacos",descripcion:'Selección de tacos en doble tortilla con combinación de pollo, al pastor y res.', categoria: "TAQUIZAS", precioBase: 11.50, tipoExtra: 'ninguno', variantes: [{ nombre: "3 Pastor, 4 Pollo, 3 Res", precioAdicional: 0 }, { nombre: "Mixtos", precioAdicional: 0.30 }] },
  { id: "taq-15",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/Taquiza-15.webp', nombre: "Taquiza 15 Tacos",descripcion:'Combo ideal para compartir, con tacos de pollo, al pastor y res en doble tortilla.', categoria: "TAQUIZAS", precioBase: 15.95, tipoExtra: 'ninguno', variantes: [{ nombre: "5 Pastor, 5 Pollo, 5 Res", precioAdicional: 0 }, { nombre: "Mixtos", precioAdicional: 1.55 }] },
  { id: "taq-20",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/taquiza-20.webp', nombre: "Taquiza 20 Tacos",descripcion:'Gran bandeja de tacos de pollo, al pastor y res, servidos en doble tortilla para mayor consistencia y sabor.', categoria: "TAQUIZAS", precioBase: 21.95, tipoExtra: 'ninguno', variantes: [{ nombre: "4 Pastor, 8 Pollo, 8 Res", precioAdicional: 0 }, { nombre: "Mixtos", precioAdicional: 1.55 }] },

  // CATEGORÍA: COMBOS (Extras Globales)
  { id: "c-art",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/combo-arturito.webp', nombre: "Combo Arturito",descripcion:'Torta o burrito + 1 taco doble tortilla. El combo perfecto para matar el antojo.', categoria: "COMBOS", precioBase: 4.95, tipoExtra: 'global', proteinas: CARNES_COMBOS, variantes: [{ nombre: "Con Torta Mexicana", precioAdicional: 0 }, { nombre: "Con Burrito", precioAdicional: 0 }] },
  { id: "c-sup",imagen:'https://pub-24b9526bf2534974a8f6ec5a149e405c.r2.dev/combo_2.webp', nombre: "Super Combo",descripcion:'Torta o burrito + 2 tacos doble tortilla. Cuando uno no es suficiente.', categoria: "COMBOS", precioBase: 5.95, tipoExtra: 'global', proteinas: CARNES_COMBOS, variantes: [{ nombre: "Con Torta Mexicana", precioAdicional: 0 }, { nombre: "Con Burrito", precioAdicional: 0 }] }
];